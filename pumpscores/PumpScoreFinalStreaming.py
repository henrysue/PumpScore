...
creds = ServiceAccountCredentials.from_json_keyfile_name('N:\Temp\Steven Nguyen\pumpscores\PIU Scoring OCR.json', scope)
...
pytesseract.pytesseract.tesseract_cmd = r'C:/Users/snadmin/AppData/Local/Tesseract-OCR/tesseract.exe' 

img = cv2.imread(r'N:\Temp\Steven Nguyen\pumpscores\data\Raw Data\bring_back_the_beat_17_19.png',0)
...
wrksheet.append_row(nameslist+numslist, value_input_option='RAW')
